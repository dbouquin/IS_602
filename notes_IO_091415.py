# This whole file cannot be run without throwing errors.
# Each block should be read as an example.
# I commented out each block as I went through this lecture so I could run the code via terminal
